            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id='dataTable'>
     		...
     		<tbody>
              ...
              <tr class="<?php echo $i%2==0?"odd":"even"?>">
				...
				<td><?php echo $list[$i]["oauth_type"]?> </td>				
                <td>
                	<button type="button" class="btn edit" onclick="jUrl('<?php echo  bUrl("edit",true,null,array("sn"=>$list[$i]["sn"]))?>')"><?php echo $this->lang->line("common_handle");?></button>					
                </td>   
