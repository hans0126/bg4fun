...
class Product extends Backend_Controller {
	...
	function delSeries()
	{
		...
		$this->deleteSeries("product_series", "seriesList?category_sn=".$category_sn);
	}
	...
	{	
		...
		$data["keyword_list"] = $keyword_list["data"];
		//--------------------------------------------------------------------		
	...
	{		
		...
		$this->addTopMenu("產品次分類",array("seriesList","editSeries","updateSeries"));
