<div id="logo"><a href="<?php echo backendUrl();?>" title=""><img src="<? echo base_url();?>template/<?php echo $this->config->item('backend_name');?>/images/logo.png" alt="Akacia" title="Akacia" border="0" /></a></div>
<div id="stay">
